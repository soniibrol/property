<div class="row">
	<div class="col-md-12">
		<h1>Edit Peminjaman Properti Internal</h1>
		<?php 
...
<div class="row">
	<div class="col-md-12">
		<h4>Daftar Peminjaman Properti <?php echo $rent['property_name']; ?></h4>
	...
	<div class="col-md-6">
		<form class="form-horizontal" role="form" method="POST" action="" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="rent_date" class="form-control date" id="rent_date" required="required" placeholder="mm/dd/yyyy" value="<?php echo $this->tanggal->tanggal_english($rent['rent_date']); ?>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8">
					...
					<input type="text" name="rent_days" id="rent_days" class="form-control" required="required" value="<?php echo $rent['rent_days']; ?>">
				</div>
			</div>
			<div class="form-group">
				<label for="rent_date_return" class="col-sm-4  control-label">Tanggal Pengembalian *</label>
				<div class="col-sm-8">
					<input type="text" name="rent_date_return" class="form-control" id="rent_date_return" required="required" placeholder="mm/dd/yyyy" readonly="true" value="<?php echo $this->tanggal->tanggal_english($rent['rent_date_return']); ?>">
				</div>
			</div>
			<div class="form-group">
				<label for="rent_desc" class="col-sm-4 control-label">Keterangan</label>
				<div class="col-sm-8">
					<textarea name="rent_desc" id="rent_desc" class="form-control" placeholder="Keterangan"><?php echo $rent['rent_description']; ?></textarea>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-4 col-sm-8">
					<input type="submit" name="submit" id="submit" class="btn btn-default" value="Ubah Data">&nbsp;
