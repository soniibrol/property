<div class="row">
	<div class="col-md-12">
		<h1>Pengembalian Peminjaman Properti</h1>
		<?php 
	...
	<div class="col-md-6">
		<form class="form-horizontal" role="form" method="POST" action="" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<?php echo $this->uang->rupiah($denda); ?>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<?php echo ($rent['rent_type']=='1') ? '<a href="'.base_url().'uploads/rent/'.$rent['rent_upload'].'">'.$rent['rent_upload'].' - DOWNLOAD'.'</a>' : '-'; ?>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<div class="col-sm-offset-4 col-sm-8">
					<input type="submit" name="submit" id="submit" class="btn btn-default" value="Kembalikan Peminjaman">&nbsp;
