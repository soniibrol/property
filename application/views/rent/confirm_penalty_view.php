<div class="row">
	<div class="col-md-12">
		<h1>Konfirmasi Bukti Pembayaran Denda</h1>
		<?php 
		...
		<form class="form-horizontal" role="form" method="POST" action="" enctype="multipart/form-data">
			<div class="form-group">
				...
				<div class="col-sm-8">
					...
					<input type="hidden" name="rent_penalty_paid" value="1">
				</div>
			</div>
			<div class="form-group">
			...
			<div id="rent_upload_internal" class="form-group">
				<label for="rent_penalty_upload" class="col-sm-4 control-label">Bukti Transfer Denda</label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<div class="col-sm-offset-4 col-sm-8">
					<input type="submit" name="submit" id="submit" class="btn btn-default" value="Konfirmasi Pembayaran Denda">&nbsp;
