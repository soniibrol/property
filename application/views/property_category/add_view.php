	...
	<div class="col-md-6">
		<form class="form-horizontal" role="form" method="POST" action="">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="property_category_code" class="form-control" id="property_category_code" required="required" placeholder="Nama Kategori Properti" maxlength="5">
				</div>
			</div>
			<div class="form-group">
				<label for="property_category_name" class="col-sm-4 control-label">Nama Kategori Properti *</label>
				<div class="col-sm-8">
					<input type="text" name="property_category_name" class="form-control" id="property_category_name" required="required" placeholder="Nama Kategori Properti">
				</div>
			</div>
			<div class="form-group">
