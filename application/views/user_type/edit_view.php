	...
	<div class="col-md-6">
		<form class="form-horizontal" role="form" method="POST" action="">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="user_type_name" class="form-control" id="user_type_name" required="required" placeholder="User Type Name" value="<?php echo $user_type['user_type_name']; ?>">
				</div>
			</div>
			<div class="form-group">
